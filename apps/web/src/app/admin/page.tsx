        ...
        <Card>
          <CardContent className="p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="/admin/import-poster" className="text-primary hover:underline">Poster → Lineup AI tool</Link></li>
              <li><Link href="/api/import-poster" className="text-muted-foreground">API endpoint</Link></li>
            </ul>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="/festivals" className="text-primary hover:underline">Browse all festivals</Link></li>
              <li><Link href="/artists" className="text-primary hover:underline">Browse all artists</Link></li>
              <li><Link href="/promoters" className="text-primary hover:underline">Browse all promoters</Link></li>
            </ul>
          </CardContent>
        </Card>
      </div>
