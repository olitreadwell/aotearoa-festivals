...
const STATUS_CLASSES: Record<FestivalStatus, string> = {
  ...
  HIATUS: 'bg-kohatu-300/30 text-kohatu-0 dark:bg-kohatu-100/70 dark:text-kohatu-300',
  DEFUNCT:
    'bg-pohutukawa-300/40 text-pohutukawa-0 dark:bg-pohutukawa-200/20 dark:text-pohutukawa-300',
  UNCONFIRMED: 'bg-tangaroa-300/30 text-tangaroa-0 dark:bg-tangaroa-100/70 dark:text-tangaroa-300',
};
...
export function FestivalStatusBadge({ status, className = '' }: FestivalStatusBadgeProps) {
  const baseClasses =
