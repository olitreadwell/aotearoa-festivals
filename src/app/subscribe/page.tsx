    ...
    <main className="mx-auto min-h-screen max-w-lg px-4 py-16">
      <div className="rounded-2xl border border-border bg-card p-8 shadow-[0_1px_2px_rgba(28,25,23,0.04)] dark:border-border dark:bg-card">
        <header className="mb-8">
          <h1 className="mb-2 text-2xl font-bold tracking-tight">Subscribe to Festival Updates</h1>
          <p className="text-sm text-muted-foreground dark:text-muted-foreground">
            Get notified about upcoming festivals in your region. We&apos;ll only email you with
            relevant updates — no spam.
          </p>
        </header>
        ...
        <p className="mt-6 text-xs text-[#888] dark:text-[#666]">
          You can unsubscribe at any time via the link in any email we send. View all festivals on
          the{' '}
          <Link href="/festivals" className="text-primary underline dark:text-primary">
            festivals page
          </Link>
          .
        </p>
